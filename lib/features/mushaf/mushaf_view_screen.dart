...
/// Audio uses the same app-wide [quranAudio] service as the Surah
/// reader, so playback started here keeps going if you navigate away,
/// and tapping any ayah plays it directly from this view too.
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('الجزء ${widget.page.juzNumber}', style: const TextStyle(color: AppColors.mutedText, fontSize: 12)),
                const Text('اضغط على أي آية لتشغيل تلاوتها', style: TextStyle(color: AppColors.mutedText, fontSize: 11)),
                Text('صفحة ${widget.page.pageNumber}', style: const TextStyle(color: AppColors.mutedText, fontSize: 12)),
              ],
            ),
          ],
        ),
